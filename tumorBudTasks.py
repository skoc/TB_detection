...
#    tsNames = inputOutput.listAllJPG([], pathPrefix,'OTC')
    ...
    valNames = inputOutput.listAllJPG([], pathPrefix, 'OTC-1-')
    valNames = inputOutput.listAllJPG(valNames, pathPrefix, 'OTC-8-')
    valNames = inputOutput.listAllJPG(valNames, pathPrefix, 'OTC-23-')

    tsNames = inputOutput.listAllJPG([], pathPrefix, 'OTC-27-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-32-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-1-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-8-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-10-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-11-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-12-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-26-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-13-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-14-')
    tsNames = inputOutput.listAllJPG(tsNames, pathPrefix, 'OTC-23-')
